...
class CROSS_SECTIONS
{
  public :
    ...
    vector<vector<d_vector> > Get_sigma_s(unsigned int i) const;
  ...
  private :
    ...
    /// multigrid.
    vector<vector<vector<d_vector> > > sigma_s_lvl;
};
...
inline vector<vector<d_vector> > CROSS_SECTIONS::Get_sigma_s(unsigned int i) const
{
