...
class CROSS_SECTIONS
{
  public :
    ...
    /// Read the cross sections generated by CEPXS.
  ...
  private :
    ...
    void Apply_angular_levels();

    /// Apply the "standard" extended transport correction of the "optimal"
    /// extended transport correction.
    void Apply_transport_correction(unsigned int i_mat,unsigned int lvl,
        double correction);
    ...
    void Create_linear_permutation(vector<ui_vector> &permutation_m,
        ui_vector &permutation,bool &identity);

    /// Create the permutation matrix and the permutation vector when the
    /// energy groups are logarithmic.
    void Create_log_permutation(vector<ui_vector> &permutation_m,
        ui_vector &permutation_b);

    /// Reorder #sigma_s, #sigma_t and #sigma_e when the cross sections are
    /// generated by CEPXS.
    void Reordering(const unsigned int n_mat,const bool linear);
